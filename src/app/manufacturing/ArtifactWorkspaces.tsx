...
export function ManufacturingWorkspace({ artifacts, exportAllLabel, exportStatus, onDownload, onDownloadAll }: { artifacts: readonly GeneratedArtifact[]; exportAllLabel: string; exportStatus: string; onDownload: (artifact: GeneratedArtifact) => void | Promise<void>; onDownloadAll: () => void | Promise<void> }) {
